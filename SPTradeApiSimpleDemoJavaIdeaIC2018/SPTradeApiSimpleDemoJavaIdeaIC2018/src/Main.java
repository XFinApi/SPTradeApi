...
public class Main {
    ...
    static void MarketTest() {
        ...
        market = XFinApi.TradeApi.ITradeApi.XFinApi_CreateMarketApi("TradeApi_win32x86/Api/SPTradeApi_R8.75.4/XFinApi.SPTradeApi.dll", err);
    ...
    static void TradeTest() {
        ...
        trade = XFinApi.TradeApi.ITradeApi.XFinApi_CreateTradeApi("TradeApi_win32x86/Api/SPTradeApi_R8.75.4/XFinApi.SPTradeApi.dll", err);
